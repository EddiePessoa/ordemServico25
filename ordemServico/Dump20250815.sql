...
INSERT INTO `tbclientes` VALUES (1,'joao da silva','rua lima','66 9999-9999','Joao.silva@gmail.com');
...
--
-- Table structure for table `tbusarios`
--

DROP TABLE IF EXISTS `tbusarios`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `tbusarios`
--

LOCK TABLES `tbusarios` WRITE;
/*!40000 ALTER TABLE `tbusarios` DISABLE KEYS */;
INSERT INTO `tbusarios` VALUES (1,'Pettisco','66999326633','Pettisco','123456','Admin');
/*!40000 ALTER TABLE `tbusarios` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-08-15 10:45:47
